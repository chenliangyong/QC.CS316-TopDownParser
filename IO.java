...
public abstract class IO
{
	...
	public static int currVal; // the current input character on "inStream"
	public static char currChar; // used to convert the variable "currVal" to the char type whenever necessary
